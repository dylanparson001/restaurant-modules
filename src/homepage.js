...
export default class home {
    ...
    static makeHome(){
        //put all of this into a container variable
        this.newTitle();
        this.newParagraph("Fat Boy's Roadside Eats is for the purist BBQ fan. At Fat Boy's Roadside Eats, we do our best to produce and serve freshly cooked meat like you would cook in your own back yard. We are more like an old-fashioned, roadside BBQ, but in a comfortable setting with a great view of the surrounding mountains and downtown Chattanooga.");
        this.newParagraph("Local restauranteurs, Lawton and Karen Haygood purchased the old Pancake Man Restaurant on the side of Missionary Ridge, to take advantage of one of the most spectacular views in all of Chattanooga. Originally part of the Kings Lodge Motel, they remodeled and opened Fat Boy's Roadside Eats on March 1, 2007.");
